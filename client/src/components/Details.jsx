...
const Details = () => {
  ...
  const deleteData = async (id) => {
    const deleted = await fetch(
      `https://eployeeregister.herokuapp.com/delete/${id}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        ...
        <CardContent>
          ...
          <div className="row">
            <div className="left_view col-lg-6 col-md-6 col-12">
              ...
              <p className="mt-3">
                <WorkIcon />
                Occuption: <span>{getdata.work}</span>
              </p>
            </div>
            <div className="right_view  col-lg-6 col-md-6 col-12">
              ...
              <p className="mt-3">
                <LocationOnIcon />
                location: <span>{getdata.add}</span>
              </p>
              <p className="mt-3">
                Description: <span>{getdata.desc}</span>
              </p>
            </div>
          </div>
        </CardContent>
